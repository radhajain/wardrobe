...
export function RecommendationPanel({
  ...
  useEffect(() => {
    ...
    const hasDirectSearch =
      session?.directSearch?.results?.status === "complete";
      ...
      <div className="recommendation-panel">
        <div className="recommendation-panel__empty">
          ...
          <div className="recommendation-panel__option">
            ...
            <p className="recommendation-panel__option-text">
              Know what you're looking for? Enter a description and we'll find
              products for you.
            </p>
            <form
              className="recommendation-panel__search-form"
    ...
    return (
      <div className="recommendation-panel">
        <div className="recommendation-panel__header">
          ...
          <button className="recommendation-panel__reset-btn" onClick={onReset}>
            Start Over
          </button>
        </div>
        ...
        <section
          ...
          className="recommendation-panel__section"
        >
        ...
        >
          ...
          {approvedSuggestions.map((suggestion) => {
            ...
            return (
              <div
                key={suggestion.id}
                className="recommendation-panel__results-group"
              >
