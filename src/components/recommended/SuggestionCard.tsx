...
export function SuggestionCard({
	...
	const handleSaveEdit = () => {
		if (editedDescription.trim() && editedDescription !== suggestion.description) {
	...
	const handleCancelEdit = () => {
		setEditedDescription(suggestion.refinedDescription || suggestion.description);
		setIsEditing(false);
	};

	const displayDescription = suggestion.refinedDescription || suggestion.description;
	const isApproved = suggestion.status === 'approved' || suggestion.status === 'refined';
