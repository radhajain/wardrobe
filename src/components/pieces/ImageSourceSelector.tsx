...
export const ImageSourceSelector = ({
  ...
  const handleLoadPreview = async () => {
    ...
    try {
      ...
      setCustomUrlError(
        "Unable to load image. The URL may be invalid or blocked.",
      );
    } finally {
      ...
      <div className="image-source-selector__panel">
        ...
        {activeTab === "upload" && (
          <>
            ...
            >
              ...
              <div className="image-source-selector__upload-hint">Max 10MB</div>
            </div>
            <input
              ref={fileInputRef}
              type="file"
        ...
        {activeTab === "url" && (
          <>
            ...
            {customUrlError && (
              <div className="image-source-selector__error">
                {customUrlError}
              </div>
            )}
          </>
